...
---WHICH 2 LOCATIONS HAD THE MOST TRIP---
SELECT*FROM TRIPS;
...
select top 5 driverid,sum(fare) fare
from trips
group by driverid
order by fare desc;
...
select (count(*)-sum(driver_not_cancelled))*100.0/sum(searches_got_quotes) from trips_details4;
